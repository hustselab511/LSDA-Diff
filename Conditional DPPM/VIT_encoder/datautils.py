...
class Dataset_ECG(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        elif self.status == 'sample':
            return self.seq[idx], self.all[idx], self.reference[idx], self.labels[idx], self.length[idx]
        else:
            return self.seq[idx], self.all[idx], self.reference[idx]
